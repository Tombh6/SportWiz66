...
namespace SportWiz66.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public AboutsController(SportWiz66Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,ImageUrl")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,ImageUrl")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
